    ...
    <el-card style="min-height: 99%;">
        <template #header> <!-- 卡片顶部区域 -->
            <div class="card-header">
                <span>楼栋信息</span>
                <div>
                    <el-button type="primary" plain @click="dialogFormVisible = true; clearAddBuilding();" :icon="AddLocation">添加楼栋</el-button>
                </div>
            </div>
        </template>
        <el-form :inline="true" :model="searchData" size="default"> <!-- 搜索表单 -->
                <el-form-item label="宿舍楼名称"><el-input v-model="searchData.name"  style="width: 200px;" placeholder="请输入宿舍楼名称"/>&nbsp;&nbsp;</el-form-item>
                <el-form-item label="宿舍楼单元数"><el-input-number v-model="searchData.unit_number" :min="1" class="input-with"/>&nbsp;&nbsp;&nbsp;</el-form-item>
                ...
                <el-form-item label="寝室数量不少于"><el-input-number  v-model="searchData.dor_number" :min="0" class="input-with"/></el-form-item>
                <el-form-item label="学生数量不少于"><el-input-number  v-model="searchData.stu_number" :min="0" class="input-with"/></el-form-item>
                <el-form-item>
